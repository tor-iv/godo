...
export const mockEvents: Event[] = [
  {
    ...
    description: 'Dance under the stars at NYC\'s most iconic rooftop bar with panoramic city views',
    date: new Date('2024-01-20T21:00:00'),
    location: {
  ...
  },
  {
    ...
    description: 'Discover cutting-edge contemporary art from emerging NYC artists',
    date: new Date('2024-01-21T19:00:00'),
    location: {
      name: 'Gallery Luna',
  ...
  },
  {
    ...
    date: new Date('2024-01-23T18:30:00'),
    location: {
  ...
  },
  {
    ...
    description: 'Paddle through Manhattan waters as the sun sets over the skyline',
    date: new Date('2024-01-24T17:30:00'),
    location: {
