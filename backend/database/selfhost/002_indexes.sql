...
CREATE INDEX idx_event_sources_next_sync ON event_sources(next_sync_at)
    WHERE is_enabled = true;

-- Sync status monitoring
CREATE INDEX idx_event_sources_status ON event_sources(last_sync_status, last_sync_at DESC);

-- Active sources
CREATE INDEX idx_event_sources_active ON event_sources(source_name) WHERE is_enabled = true;
